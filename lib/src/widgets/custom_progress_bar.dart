...
class CustomProgressBar extends StatefulWidget {
  ...
  /// type of [Color] or Colors used to change the backgroundColor of the  progress bar
  ...
  /// type of EdgeInsets which gives padding to the CustomProgressBar
  final EdgeInsets? padding;

  /// type of EdgeInsets which gives margin to the CustomProgressBar
  ...
  /// type of [ProgressType] which changes the shape of progress bar based on the type ie, circular and linear
  final ProgressType type;

  /// type of [ProgressHeadType] which changes the shape of progress head based on the type ie, circular and square
  final ProgressHeadType? progressHeadType;
...
class _CustomProgressBarState extends State<CustomProgressBar>
  ...
  Widget build(BuildContext context) {
    ...
    final containerWidget = Container(
        ...
        child: widget.type == ProgressType.linear
            ? CustomPaint(
    ...
    return widget.type == ProgressType.linear
        ? Material(
...
class LinearPainter extends CustomPainter {
  LinearPainter({
    ...
    if (progressHeadType == ProgressHeadType.square) {
  ...
  final MaskFilter? mask;
  final bool? clipLinearGradient;
  ProgressHeadType? progressHeadType;
...
class CirclePainter extends CustomPainter {
  CirclePainter(
    ...
    _paintLine.style = PaintingStyle.stroke;
    _paintLine.strokeWidth = circleWidth!;
    if (progressHeadType == ProgressHeadType.circular) {
      _paintLine.strokeCap = StrokeCap.round;
    } else if (progressHeadType == ProgressHeadType.square) {
